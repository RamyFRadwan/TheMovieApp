...
public class Movie implements Parcelable {
    ...
    private String backdrop_path ,backdrop;
    private double vote_average;
    private long vote_count;

    public Movie(long id, String title, String overview, String release_date, String image_path, String backdrop_path, double vote_average, long vote_count) {
        this.setId(id);
        this.setTitle(title);
        this.setOverview(overview);
        this.setRelease_date(release_date);
        this.setPoster_path(image_path);
        this.setBackdrop_path(backdrop_path);
        this.setVote_average(vote_average);
        this.setVote_count(vote_count);
    }

    public Movie(long id, String title, String overview, String release_date, String poster, String backdrop, double vote_average) {
        this.setId(id);
        this.setTitle(title);
        this.setOverview(overview);
        this.setRelease_date(release_date);
    ...
    public void setPoster(String image_path){this.poster = image_path;}
